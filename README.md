...
📁 Project Structure
FaceGuard/ ├── dataset/ # Stores images of known individuals ├── recordings/ # Video recordings of each session ├── logs/attendance.csv # CSV file logging attendance records ├── main.py # Main application file ├── encode_faces.py # Preprocess & encode known faces └── README.md # Project documentation
